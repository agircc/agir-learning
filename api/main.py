...
from api.routes import scenarios, episodes, steps, users, memories, chat, auth, completions
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "https://learning.agir.cc"],  # Next.js dev server
